...
const OPERATOR_TYPE_ICONS = [
  { icon: 'safari', key: 'safari' },
  { icon: 'shuttle', key: 'shuttle' },
  { icon: 'fishing', key: 'fishing' },
  { icon: 'yacht', key: 'yacht' },
  { icon: 'trailGuide', key: 'trail' },
  { icon: 'gameLodge', key: 'lodge' },
  { icon: 'eastAfrica', key: 'eastAfrica' },
  { icon: 'islandTransfer', key: 'islandTransfer' },
  { icon: 'delivery', key: 'logistics' },
]

const FEATURE_ICONS = [
  { icon: 'bookingCalendar', key: 'bookings' },
  { icon: 'teamRoles', key: 'staff' },
  { icon: 'gameLodge', key: 'lodging' },
  { icon: 'fleet', key: 'fleet' },
  { icon: 'proformaInvoice', key: 'invoices' },
  { icon: 'dashboardReports', key: 'reports' },
  { icon: 'firearmRegister', key: 'firearm' },
  { icon: 'trailsModule', key: 'trails' },
  { icon: 'delivery', key: 'logistics' },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif' }}>
      ...
      <section style={{ background:'var(--cream)', padding:'4rem 2rem', textAlign:'center' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(160px, 1fr))', gap:'1rem', maxWidth:'900px', margin:'0 auto' }}>
          {OPERATOR_TYPE_ICONS.map(o => (
            <div key={o.key} style={{ background:'white', borderRadius:'1rem', padding:'1.5rem 1rem', border:'1px solid var(--gray-200)', transition:'box-shadow 0.2s, border-color 0.2s', cursor:'default' }}
      ...
      <section style={{ padding:'4rem 2rem', maxWidth:'1100px', margin:'0 auto' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'1.25rem' }}>
          {FEATURE_ICONS.map(f => (
            <div key={f.key} className="card card-lg card-shadow"
