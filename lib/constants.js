...
export const GATED_MODULES = ['certifications', 'shifts', 'costs', 'leave', 'quotations', 'ical_sync', 'delivery_management', 'checklists', 'guest_register', 'rate_sheet', 'commission_reporting']
...
export const ALL_MODULE_INFO = {
  ...
  guest_register: { label: 'Guest Register & Group Bookings', description: 'Persistent guest directory with booking history, plus named travelers on group bookings.' },
  rate_sheet: { label: 'Rate Sheet Library', description: 'Reusable rate cards by residency and guest category, used to build line items on quotes and invoices.' },
  commission_reporting: { label: 'STO/RACK Trade Pricing & Commission Report', description: 'Trade-tier pricing (RACK/STO/Net) on rate sheet items, plus a report totalling commission owed.' },
}
...
export const TIER_INCLUDED_MODULES = {
  free: [],
  basic: ['quotations'],
  standard: ['shifts', 'leave', 'quotations', 'checklists', 'guest_register', 'rate_sheet'],
  professional: ['shifts', 'leave', 'certifications', 'quotations', 'checklists', 'ical_sync', 'delivery_management', 'guest_register', 'rate_sheet', 'commission_reporting'],
  enterprise: ['shifts', 'leave', 'certifications', 'costs', 'quotations', 'checklists', 'ical_sync', 'delivery_management', 'guest_register', 'rate_sheet', 'commission_reporting'],
}
...
export const MODULE_ADDON_KEY = {
  ...
  commission_reporting: 'commission_reporting',
}
...
export const MODULE_LABELS = {
  ...
  guest_register: 'Guest Register & Group Bookings',
  rate_sheet: 'Rate Sheet Library',
  commission_reporting: 'STO/RACK Trade Pricing & Commission Report',
}
