...
export const GATED_MODULES = ['certifications', 'shifts', 'costs', 'leave', 'quotations']
...
export const TIER_INCLUDED_MODULES = {
  ...
  professional: ['shifts', 'leave', 'certifications', 'quotations'],
  enterprise: ['shifts', 'leave', 'certifications', 'costs', 'quotations'],
}
