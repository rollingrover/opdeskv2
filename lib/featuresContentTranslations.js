...
export const FEATURES_TRANSLATIONS = {
  ...
  'delivery-management': {
    en: {
      ...
      benefits: [
        ...
        'Running more than one depot or branch? Link multiple locations under one login',
        'Add drivers and office staff as team members with their own login and role',
  ...
  'booking-widget': {
    en: {
      ...
      metaTitle: 'Website Booking Widget for Tour Operators & Lodges',
      metaDescription: 'Add a direct booking form to your own website — guests request a stay or excursion without leaving your page, and it lands straight in your OpDesk dashboard.',
      keywords: ['booking widget for tour operators', 'website booking form safari lodge', 'direct booking software Africa', 'embed booking form website'],
      heroTagline: 'Stop losing bookings to slow email back-and-forth',
      intro: 'Every enquiry that has to wait for an email reply is a booking that might go cold. The Booking Widget puts a real request form directly on your own website — showing your actual booking types, durations and rates — so a guest can submit a request in the moment, without ever leaving your page.',
      benefits: [
        'Embeds on any website — WordPress, Wix, Squarespace, or a custom site',
        'Shows your real booking types and duration-based pricing, kept in sync automatically',
        'Requests land directly in your OpDesk Bookings list as pending, ready to confirm',
        'Displays in the language you\u2019ve set for your business',
      ],
      forWhom: 'Any operator with their own website who wants to capture bookings directly, rather than relying only on phone calls, WhatsApp, or email enquiries.',
    },
  },
  'rate-sheet-gate-fees': {
    en: {
      title: 'Rate Sheet & Gate Fee Calculator',
      metaTitle: 'Rate Sheet Software with Park Entry Fee Calculation',
      metaDescription: 'Build a reusable rate sheet by residency and guest type, and automatically calculate park or reserve entry fees by nationality on every booking.',
      keywords: ['tour rate sheet software', 'park entry fee calculator', 'SADC pricing software tourism', 'trade rate STO RACK pricing software'],
      heroTagline: 'Local, SADC, and international guests, priced correctly every time',
      intro: 'Most South African parks and reserves charge different entry fees for local, SADC, and international visitors — and that fee changes depending on which park a tour actually visits. The Rate Sheet lets you save reusable rates once, while gate fees are entered per booking so they\u2019re always accurate to the actual park being visited, then calculated automatically from your travelers\u2019 nationalities.',
      benefits: [
        'Reusable rate sheet by residency and guest category (adult, child, infant)',
        'Per-booking gate fee entry, since the correct rate depends on which park a specific tour visits',
        'Automatic calculation from named travelers, plus a quick headcount option for large groups',
        'Trade-tier pricing (RACK/STO/Net) and a commission report for operators selling through travel agents',
        'Pulls straight into quotes and invoices as line items',
      ],
      forWhom: 'Safari operators, tour guides, and any business taking guests into a park or reserve with residency-based entry fees.',
    },
  },
  'hr-package': {
    en: {
      title: 'HR Package for Bureaus & Consultancies',
      metaTitle: 'HR Management Software for HR Bureaus & Consultancies',
      metaDescription: 'A standalone package for HR bureaus managing staff certifications, shifts, leave and cost-to-company for several client businesses from one login.',
      keywords: ['HR software for consultancies', 'multi client HR management software', 'outsourced HR software Africa', 'staff management software for HR bureaus'],
      heroTagline: 'One login, every client\u2019s HR, kept separate and organized',
      intro: 'Running HR for more than one business usually means juggling separate spreadsheets or systems per client. The HR Package gives a bureau one login with each client set up as its own linked, private workspace — client businesses never need their own OpDesk account at all.',
      benefits: [
        'Certifications, shifts, leave and cost-to-company for every client, from one login',
        'Each client is a fully separate, private workspace — nothing crosses over between clients',
        'One included client, more added as needed',
        'No tourism-specific clutter — built around staff and HR only, not bookings or fleet',
      ],
      forWhom: 'HR bureaus, consultancies, and anyone managing staff administration for more than one business at once.',
    },
  },
  ...
  'logistics-delivery-software': {
    en: {
      ...
      benefits: [
        ...
        'Multiple depots or branches linked under one login, if you run more than one',
        'Drivers and office staff added as team members with their own logins',
