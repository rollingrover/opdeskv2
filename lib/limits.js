 ...
 */
const POOLED_RESOURCES = ['vehicles', 'rooms', 'vessels']
const LIMIT_KEY = { guides: 'guides', bookings_per_month: 'bookings_per_month', vehicles: 'capacity', rooms: 'capacity', vessels: 'capacity' }
...
const RESOURCE_ADDON_KEY = { vehicles: 'vehicles', guides: 'guides', rooms: 'rooms', seats: 'seats', vessels: 'vessels' }
