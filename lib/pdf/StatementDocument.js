...
export function StatementDocument({ company, client, orders, payments, totalInvoiced, totalPaid, balance, periodLabel }) {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer} fixed>
          {company.name} · Generated by OpDesk · This statement reflects records held in OpDesk and is provided for reference — please confirm balances with your own records.
        </Text>
      </Page>
    </Document>
  )
