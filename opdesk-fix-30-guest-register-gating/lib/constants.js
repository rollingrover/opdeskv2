...
export const GATED_MODULES = ['certifications', 'shifts', 'costs', 'leave', 'quotations', 'ical_sync', 'delivery_management', 'checklists', 'guest_register']
...
export const TIER_INCLUDED_MODULES = {
  free: [],
  basic: ['quotations'],
  standard: ['shifts', 'leave', 'quotations', 'checklists', 'guest_register'],
  professional: ['shifts', 'leave', 'certifications', 'quotations', 'checklists', 'ical_sync', 'delivery_management', 'guest_register'],
  enterprise: ['shifts', 'leave', 'certifications', 'costs', 'quotations', 'checklists', 'ical_sync', 'delivery_management', 'guest_register'],
}
