...
const PROTECTED_PREFIXES = ['/dashboard', '/bookings', '/staff', '/lodging', '/fleet', '/invoices', '/settings', '/reports', '/guides', '/trails', '/firearm-register', '/calendar', '/support', '/admin', '/delivery', '/quotations', '/checklists', '/guests']
...
const NON_LOCALIZED_PATHS = ['/privacy', '/paia-manual', '/operators', '/book', '/sitemap.xml', '/robots.txt']
